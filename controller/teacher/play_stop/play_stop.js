...
function disableElements(){
    ...
    //assignActivity
    document.getElementById("assignActivity").style.display="none";
...
function enableElements2(){
    ...
    //saveActivity
    document.getElementById("saveActivity").style.display="inline";

    //assignActivity
    document.getElementById("assignActivity").style.display="inline";
